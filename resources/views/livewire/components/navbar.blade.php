<nav class="sticky top-0 left-0 bg-white z-50 w-full border-b border-gray-200">
    <div class="max-w-6xl w-full mx-auto py-2 px-4 flex items-center justify-between">
        ...
        <ul class="flex items-center font-bold 680px:hidden">
        ...
        <ul class="flex items-center 680px:hidden">
        ...
        <div x-data="{ open: false }" class="hidden 680px:block">
            <img src="https://api.iconify.design/ph:text-align-right-bold.svg?color=%23141515" alt="Align Icon" width="30">
            <div class="fixed left-0 top-0 bg-white/10 backdrop-blur-sm w-full h-full">
                <div class="h-full max-w-[300px] bg-white shadow-lg">
